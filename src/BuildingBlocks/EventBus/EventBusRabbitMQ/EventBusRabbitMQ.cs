...
namespace EventBusRabbitMQ
{
    ...
    {
        private const string BROKER_NAME = "trading_suite_event_bus";
        ...
        public void Publish(IntegrationEvent integrationEvent)
        {
            ...
            var policy = Policy.Handle<BrokerUnreachableException>()
                ...
                {
                    _logger.LogWarning(ex, "Could not publish event: {EventId} after {Timeout}s", integrationEvent.Id, $"{time.TotalSeconds:n1}");
                });
